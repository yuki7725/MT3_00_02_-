...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(0, kRowHeight * 5 * 3, inverseM1, "inverse");
		MatrixScreenPrintf(0, kRowHeight * 5 * 4, inverseM2, "inverse");
...
Matrix4x4 Inverse(const Matrix4x4& m1)
{
	...
	a = (m1.m[0][0] * m1.m[1][1] * m1.m[2][2] * m1.m[3][3]) +
	...
	result.m[0][0] = (1 / a * ((m1.m[1][1] * m1.m[2][2] * m1.m[3][3]) +
	...
	result.m[0][1] = (1 / a * ( - (m1.m[0][1] * m1.m[2][2] * m1.m[3][3]) -
	...
	result.m[0][2] = (1 / a * ((m1.m[0][1] * m1.m[1][2] * m1.m[3][3]) +
	...
	result.m[0][3] = (1 / a * ( - (m1.m[0][1] * m1.m[1][2] * m1.m[2][3]) -
	...
	result.m[1][0] = (1 / a * ( - (m1.m[1][0] * m1.m[2][2] * m1.m[3][3]) -
	...
	result.m[1][1] = (1 / a * ((m1.m[0][0] * m1.m[2][2] * m1.m[3][3]) +
	...
	result.m[1][2] = (1 / a * ( - (m1.m[0][0] * m1.m[1][2] * m1.m[3][3]) -
	...
	result.m[1][3] = (1 / a * ((m1.m[0][0] * m1.m[1][2] * m1.m[2][3]) +
	...
	result.m[2][0] = (1 / a * ((m1.m[1][0] * m1.m[2][1] * m1.m[3][3]) +
	...
	result.m[2][1] = (1 / a * ( - (m1.m[0][0] * m1.m[2][1] * m1.m[3][3]) -
	...
	result.m[2][2] = (1 / a * ((m1.m[0][0] * m1.m[1][1] * m1.m[3][3]) +
	...
	result.m[2][3] = (1 / a * ( - (m1.m[0][0] * m1.m[1][1] * m1.m[2][3]) -
	...
	result.m[3][0] = (1 / a * ( - (m1.m[1][0] * m1.m[2][1] * m1.m[3][2]) -
	...
	result.m[3][1] = (1 / a * ((m1.m[0][0] * m1.m[2][1] * m1.m[3][2]) +
	...
	result.m[3][2] = (1 / a * ( - (m1.m[0][0] * m1.m[1][1] * m1.m[3][2]) -
	...
	result.m[3][3] = (1 / a * ((m1.m[0][0] * m1.m[1][1] * m1.m[2][2]) +
